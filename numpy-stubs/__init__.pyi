...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    def __radd__(self, other: ArrayLike) -> ndarray: ...
    def __sub__(self, other: ArrayLike) -> ndarray: ...
    def __rsub__(self, other: ArrayLike) -> ndarray: ...
    def __mul__(self, other: ArrayLike) -> ndarray: ...
    def __rmul__(self, other: ArrayLike) -> ndarray: ...
    def __floordiv__(self, other: ArrayLike) -> ndarray: ...
    def __rfloordiv__(self, other: ArrayLike) -> ndarray: ...
    def __pow__(self, other: ArrayLike) -> ndarray: ...
    def __rpow__(self, other: ArrayLike) -> ndarray: ...
    def __truediv__(self, other: ArrayLike) -> ndarray: ...
    def __rtruediv__(self, other: ArrayLike) -> ndarray: ...
...
class ufunc:
    ...
    @overload
    def __call__(self, *args: _Scalar) -> float: ...
    @overload
    def __call__(
        self,
        *args: ndarray,
...
import pandas as pd
def asarray(arr: pd.Series) -> ndarray: ...
